...
public class Testing {
  ...
  public void testIncrementAndResizing() {
    ...
    //table.increment(new Color(1, 3, 67));
    
    //WHY DOES THIS WORK FOR NEWCOLOR AND NOT COLOR.CONSTANT???
    //table.increment(new Color(0, 128, 0));
  ...
  public void testQuadraticProbing() {
    ...
    //System.out.println(table.toString());
    //System.out.println(table.getCountAt(4));
    //System.out.println(table.toString());
  ...
  public void testLowLoadFactor() {
    ...
    table.put(Color.BLACK, 5);
    assertEquals(1, table.getSize());
    //System.out.println("should be 19: " + table.getCapacity());
